...
const totalContributions = GAMES_JSON.reduce( (tot, game) =>
{
...
const totalRaised = GAMES_JSON.reduce( (tot, game) =>
    {
        return tot + game.pledged;
    }, 0);
...
const firstGameChild = document.createElement('div');

firstGameChild.innerHTML = `
    <p>${firstgame.name}</p>
    `;
...
const secondGameChild = document.createElement('div');

secondGameChild.innerHTML = `
    <p>${secondgame.name}</p>
    `;
